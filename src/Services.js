    ...
    <div className="servicesCards">
      <Card style={{ width: "20rem" }}>
        ...
        <div className="cardDiv">
          <Card.Img variant="top" src={require("./images/rider.png")} />
        </div>
        <Card.Body>
          <Card.Text>
      ...
      <Card style={{ width: "20rem" }}>
        ...
        <div className="cardDiv">
          <Card.Img variant="top" src={require("./images/pushmower.png")} />
        </div>
        <Card.Body>
          <Card.Text>
            <div className="serviceInfo">
      ...
      <Card style={{ width: "20rem" }}>
        ...
        <div className="cardDiv">
          <Card.Img variant="top" src={require("./images/generator.png")} />
        </div>
        <Card.Body>
          <Card.Text>
            <div className="serviceInfo">
      ...
      <Card style={{ width: "20rem" }}>
        ...
        <div className="cardDiv">
          <Card.Img variant="top" src={require("./images/heater.png")} />
        </div>
        <Card.Body>
          <Card.Text>
            <div className="serviceInfo">
      ...
      <Card style={{ width: "20rem" }}>
        ...
        <div className="cardDiv">
          <Card.Img variant="top" src={require("./images/trimmer.png")} />
        </div>
        <Card.Body>
          <Card.Text>
            <div className="serviceInfo">
